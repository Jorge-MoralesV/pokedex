// To parse this data:
//
//   import { Convert, PokemonApi } from "./file";
//
//   const PokemonApi = Convert.toPokemonApi(json);
//
...
export class Convert {
    public static toPokemonApi(json: string): PokemonApi {
        return cast(JSON.parse(json), r("PokemonApi"));
    }

    public static PokemonApiToJson(value: PokemonApi): string {
        return JSON.stringify(uncast(value, r("PokemonApi")), null, 2);
    }
}
